                ...
                <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data" id="profile-form">
                    ...
                    <div class="profile-img-section">
                        <div class="img-container">
                            <img src="{{ auth()->user()->profile_picture ? Storage::url(auth()->user()->profile_picture) : 'https://ui-avatars.com/api/?name=' . urlencode(auth()->user()->name) . '&size=200&background=f35525&color=fff' }}"
                        ...
                        <p class="img-text">Formats supportés: JPG, PNG, SVG. Taille max: 2 Mo</p>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('user_name') is-invalid @enderror"
                                id="user_name" name="user_name" value="{{ old('user_name', auth()->user()->user_name) }}">
                            @error('user_name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend">{{ auth()->user()->indicatif }}</div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <p class="form-text">Le mot de passe doit contenir au moins 8 caractères, une majuscule, une
