                    ...
                    <div class="alert alert-info bg-light border-0 rounded-3">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <p><strong><i class="fas fa-percent me-2 text-muted"></i>Frais de service (2%):</strong></p>
...
<style>
    ...
    .payment-option-card { transition: all 0.3s ease; background: white; }
    .payment-option-card:hover { transform: translateY(-3px); box-shadow: 0 5px 15px rgba(0,0,0,0.1); }
    .btn-primary { background: linear-gradient(135deg, #4e54c8, #8f94fb); border: none; box-shadow: 0 4px 15px rgba(78, 84, 200, 0.3); transition: all 0.3s ease; }
    .btn-primary:hover { background: linear-gradient(135deg, #3a3f99, #6c71e0); transform: translateY(-2px); box-shadow: 0 7px 20px rgba(78, 84, 200, 0.4); }
    .btn-success { background: linear-gradient(135deg, #28a745, #20c997); border: none; box-shadow: 0 4px 15px rgba(40, 167, 69, 0.3); transition: all 0.3s ease; }
    .btn-success:hover { background: linear-gradient(135deg, #218838, #1aa179); transform: translateY(-2px); box-shadow: 0 7px 20px rgba(40, 167, 69, 0.4); }
    .alert-info { background: linear-gradient(to right, #f8f9fa, #e9ecef); border-left: 4px solid #4e54c8; }
</style>
