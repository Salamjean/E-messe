<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row" style="background-color: #f35525; color:white">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="index.html">
            <img src="{{asset('assets/assets/images/logo_E-messeFORME.png')}}" alt="logo" class="logo-dark" />
            <img src="{{asset('assets/assets/images/logo_E-messeFORME.png')}}" alt="logo-light" class="logo-light">
          </a>
          <a class="navbar-brand brand-logo-mini" href="index.html"><img src="{{asset('assets/assets/images/logo_E-messeFORME.png')}}" alt="logo" /></a>
          ...
          <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item dropdown d-none d-xl-inline-flex user-dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                ...
                <a href="{{route('user.logout')}}" class="dropdown-item"><i class="dropdown-item-icon icon-power text-primary"></i>Déconnexion</a>
              </div>
            </li>
          </ul>
