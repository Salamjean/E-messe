...
@section('content')
    ...
    <div class="container-fluid">
        <div class="content-header">
            <h2><i class="fas fa-plus-circle me-2"></i> Ajouter une Information de Contact</h2>
        </div>

        <div class="form-card">
            <form action="{{ route('content.contact-infos.store') }}" method="POST">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="type" id="type" class="form-select @error('type') is-invalid @enderror"
                            ...
                            <option value="address" {{ old('type') == 'address' ? 'selected' : '' }}>Adresse</option>
                        </select>
                        @error('type')
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="title" id="title"
                            ...
                            placeholder="ex: Écrivez-nous" required>
                        @error('title')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="value" id="value"
                            ...
                            placeholder="ex: contact@emesse.com" required>
                        @error('value')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="subtitle" id="subtitle"
                            ...
                            placeholder="ex: Nous répondons en 24h">
                        @error('subtitle')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
