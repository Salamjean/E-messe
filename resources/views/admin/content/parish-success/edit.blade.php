                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="d-flex align-items-center">
                            <h6>Modifier un Succès de Paroisse</h6>
                    ...
                    <div class="card-body">
                        <form action="{{ route('content.parish-success.update', $story) }}" method="POST">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('location') is-invalid @enderror"
                                            id="location" name="location" value="{{ old('location', $story->location) }}"
                                            required>
                                        @error('location')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                            ...
                                            id="active_users" name="active_users"
                                            value="{{ old('active_users', $story->active_users) }}" required>
                                        @error('active_users')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                            ...
                                            id="masses_reserved" name="masses_reserved"
                                            value="{{ old('masses_reserved', $story->masses_reserved) }}" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('participation_increase', $story->participation_increase) }}"
                                            placeholder="Ex: +45%">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                            rows="5" required>{{ old('description', $story->description) }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="is_active" name="is_active"
                                            value="1" {{ old('is_active', $story->is_active) ? 'checked' : '' }}>
                            ...
                            <div class="d-flex justify-content-end mt-4">
                                ...
                                <button type="submit" class="btn btn-primary m-0">Mettre à jour</button>
                            </div>
                        </form>
                    </div>
                </div>
