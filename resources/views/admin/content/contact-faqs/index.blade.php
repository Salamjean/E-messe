            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h3 class="card-title">FAQs de Contact</h3>
                        <a href="{{ route('content.contact-faqs.create') }}" class="btn btn-primary">
                    ...
                    <div class="card-body">
                        ...
                        @if ($faqs->count() > 0)
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped" id="contactFaqsTable">
                                    <thead>
                                        <tr>
                                            <th>Ordre</th>
                                            <th>Question</th>
                                    ...
                                    <tbody>
                                        @foreach ($faqs as $faq)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('content.contact-faqs.edit', $faq) }}"
                                                        class="btn btn-sm btn-info">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <form action="{{ route('content.contact-faqs.destroy', $faq) }}"
