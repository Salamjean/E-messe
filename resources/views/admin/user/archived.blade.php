                    ...
                    <div class="paroisse-card">
                        <div class="card-header">
                            ...
                            <div class="actions">
                                <form action="{{ route('users.restore', $user->id) }}" method="POST"
                                    ...
                                    @csrf
                                    <button type="submit" class="btn-icon edit-btn" title="Désarchiver">
                        ...
                        <div class="card-body">
                            ...
                            <div class="paroisse-info">
                                ...
                                <p><i class="fas fa-calendar-times"></i> Archivé le :
                                    {{ \Carbon\Carbon::parse($user->archived_at)->format('d/m/Y à H:i') }}</p>
                            </div>
                        </div>
                    </div>
                @endforeach
