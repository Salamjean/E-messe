                ...
                <div class="card signup-card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="needs-validation" method="POST" enctype="multipart/form-data"
                            action="{{ route('paroisse.update', $paroisse->id) }}" novalidate>
                            @csrf
                            @method('PUT')
                                ...
                                <div class="column">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="name" id="name"
                                            value="{{ old('name', $paroisse->name) }}"
                                            placeholder="Entrez le nom de la paroisse" required>
                                        @error('name')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="contact" id="contact"
                                            value="{{ old('contact', $paroisse->contact) }}"
                                ...
                                <div class="column">
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control" name="email" id="email"
                                            ...
                                            placeholder="Entrez l'email de la paroisse" required>
                                        @error('email')
                                            <div class="invalid-feedback d-block">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <select class="form-control" id="ville_id" name="ville_id" required>
                                            ...
                                            @foreach ($villes as $ville)
                                                <option value="{{ $ville->id }}"
                                                    {{ old('ville_id', $paroisse->ville_id) == $ville->id ? 'selected' : '' }}>
                                                    {{ $ville->nom_ville }}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="profile-picture-section">
                                ...
                                <div class="profile-upload-container">
                                    <div class="profile-preview" id="profile-preview-container">
                                        <img src="{{ $paroisse->profile_picture_url }}" alt="Photo de la paroisse"
                                            id="profile-preview">
                                    </div>
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    ...
                    previewContainer.innerHTML =
                        `<img src="${e.target.result}" alt="Aperçu de la photo" id="profile-preview">`;
                }
