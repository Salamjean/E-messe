    ...
    <div class="profile-container">
        <div class="profile-card">
            ...
            <div class="profile-body">
                ...
                <form action="{{ route('paroisse.profile.update') }}" method="POST" enctype="multipart/form-data"
                    id="paroisse-form">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                name="name" value="{{ old('name', Auth::guard('paroisse')->user()->name) }}" readonly>
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('localisation') is-invalid @enderror"
                                ...
                                value="{{ old('localisation', Auth::guard('paroisse')->user()->localisation) }}">
                            @error('localisation')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control @error('email') is-invalid @enderror" id="email"
                                name="email" value="{{ old('email', Auth::guard('paroisse')->user()->email) }}" readonly>
                            @error('email')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('contact') is-invalid @enderror" id="contact"
                                name="contact" value="{{ old('contact', Auth::guard('paroisse')->user()->contact) }}"
                                required>
                            @error('contact')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
