...
<style>
    :root {
        --primary-color: #cca45e;
        --primary-light: '#cca45e';
        --primary-dark: '#cca45e';
        --light-color: #ffffff;
        --dark-color: #212529;
        --gray-color: #f86435;
    ...
    <div class="auth-container">
        <div class="auth-card animate__animated animate__fadeIn">
            <div class="auth-header">
                <img src="{{ asset('assets/assets/images/logo_principal.svg') }}" class="auth-logo floating"
                    alt="Logo">
            ...
            <div class="auth-body">
                <form method="POST" action="{{ route('paroisse.validate', $email) }}">
                    @csrf
                    @method('post')
                    ...
                    <div class="input-group">
                        ...
                        <input class="input-field" type="text" name="code" placeholder="Code de vérification"
                    ...
                    <div class="input-group">
                        <i class="fas fa-key input-icon"></i>
                        <input class="input-field" type="password" name="confirme_password" id="confirmPassword"
                    ...
                    <button type="submit"
                        class="auth-btn animate__animated animate__pulse animate__infinite animate__slower">
