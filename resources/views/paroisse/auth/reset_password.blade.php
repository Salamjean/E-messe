...
<head>
    ...
    <title>Nouveau mot de passe - Paroisse E-Messe</title>
...
<body>
    <div class="auth-card">
        <div class="auth-left">
            <div class="left-content">
                <h1>Sécurisez votre<br>espace paroisse.</h1>
                <p>Un mot de passe robuste garantit la protection des informations paroissiales, des intentions de messe et des offrandes.</p>
                ...
                <ul class="requirement-list">
                    ...
                    <li><i class="fas fa-circle" id="req-special"></i> Caractère spécial (@, $, !, %, etc.)</li>
                </ul>
            </div>
        </div>
        ...
        <div class="auth-right">
            <div class="auth-header">
                ...
                <p>Définissez le nouveau mot de passe de votre paroisse.</p>
            </div>

            <form method="POST" action="{{ route('paroisse.reset-password.update') }}" id="resetPasswordForm">
                @csrf
                @php
    ...
    <script>
        ...
        document.getElementById('resetPasswordForm').addEventListener('submit', function(e) {
            ...
            btnText.textContent = 'Mise à jour en cours...';
