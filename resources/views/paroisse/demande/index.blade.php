...
@section('content')
    ...
    <div id="confirmationModal"
        ...
        <div
            style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); background: white; padding: 20px; border-radius: 8px; width: 400px;">
            <h3>Confirmation</h3>
            <p>Êtes-vous sûr de vouloir marquer ces demandes comme célébrées et générer le PDF ?</p>
            <p><strong>Note:</strong> Cette action changera le statut des demandes sélectionnées en "célébrée" après
                vérification que toutes les dates ont été célébrées.</p>
            ...
            fetch(updateStatusUrl, {
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        ...
                        alert('Une erreur s\'est produite lors de la mise à jour du statut: ' + (data.error ||
                            'Erreur inconnue'));
                        downloadBtn.innerHTML = originalText;
                        downloadBtn.disabled = false;
                    }
