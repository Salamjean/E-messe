...
<div class="retraits-container">
    ...
    <div class="retraits-header">
        <div>
            <h1><i class="fas fa-history me-2"></i>Demandes des retraits en attente</h1>
            <p>Consultez la liste de vos demandes de retrait en attente, de la paroisse {{ Auth::guard('paroisse')->user()->name }}!</p>
        </div>
