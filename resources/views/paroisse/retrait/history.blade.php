    ...
    <div class="retraits-container">
        ...
        <div class="retraits-header">
            <div>
                ...
                <p>Consultez l'historique de vos demandes de retrait, de la paroisse
                    {{ Auth::guard('paroisse')->user()->name }}!</p>
            </div>
                                ...
                                <tbody>
                                    @forelse($retraits as $retrait)
                                        <tr>
                                            ...
                                            <td class="text-center">{{ number_format($retrait->montant, 0, ',', ' ') }} FCFA
                                            </td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                @if ($retrait->statut == 'en_attente')
                                                    <form action="{{ route('paroisse.retrait.annuler', $retrait->id) }}"
