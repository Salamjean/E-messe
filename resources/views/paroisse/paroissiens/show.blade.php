        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-4 text-center">
                    @if($paroissien->photo)
                        <img src="{{ asset('storage/'.$paroissien->photo) }}" alt="Photo" class="img-fluid rounded-circle" style="max-width: 200px;">
                    @else
                        ...
                        <tr>
                            ...
                            <td>
                                @if($paroissien->est_baptise)
                                    <span class="badge bg-success">Oui</span> le {{ $paroissien->date_bapteme->format('d/m/Y') }}
                                @else
                                    <span class="badge bg-secondary">Non</span>
                                @endif
                            </td>
