...
@section('content')
    ...
    <div class="container-fluid mt-4 " style="background-color: #f8fafc;">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-3xl mx-auto">
                ...
                <div class="rounded-xl shadow-lg p-6 mb-8 text-white"
                    style="background: linear-gradient(135deg, #7ebac4 0%, #7ebac4 100%);">
                    <p class="text-3xl font-bold text-center" id="currentAmount">
                        {{ number_format($paroisse->montant_offrande ?? 0, 0, ',', ' ') }} Fcfa</p>
                    <h2 class="text-lg font-semibold mb-2 text-center">Montant actuel de demande de messe</h2>
                </div>

                <!-- Carte du formulaire -->
                <div class="container-fluid rounded-2xl overflow-hidden shadow-xl" style="background-color: #ffffff;">
                    <div class="container-fluid px-6 py-8 sm:p-10">
                        <form id="offrandeForm" method="POST" action="{{ route('paroisse.offrande.store') }}">
                            ...
                            <div class="container-fluid space-y-6">
                                <!-- Champ Montant -->
                                <div>
                                    <label for="montant" class="block text-sm font-medium" style="color: #181824;">Montant
                                        de demande (Fcfa)</label>
